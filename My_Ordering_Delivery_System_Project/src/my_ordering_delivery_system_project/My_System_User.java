 ...
 * @author hp
 */
public class My_System_User extends javax.swing.JFrame {
//variables for database
    ...
    /**
     * Creates new form My_System_User
     */
    public My_System_User() {
        initComponents();
        try {
 ...
 //initliazation
        ...
        try {
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + address + "','" + ssn + "','" + password + "','"+"System User"+"');";
...
//insert
        ...
        try{    
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + ssn + "','" + "System User" + "','"+" "+"','" +""+"','" +""+ "');";
...
//insert
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(My_System_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new My_System_User().setVisible(true);
            }
        });
    }
