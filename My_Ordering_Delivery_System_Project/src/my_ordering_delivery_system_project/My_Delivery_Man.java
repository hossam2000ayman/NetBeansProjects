 ...
 * @author hp
 */
public class My_Delivery_Man extends javax.swing.JFrame {

    private final String url = "jdbc:sqlserver://localhost\\ABDO_HARB_HOSSAM;databaseName=My_Ordering_Delivery_System_Project;"
            + "user=sa;password=sql2020$$;";
    /**
     * Creates new form My_Delivery_Man
     */
    public My_Delivery_Man() {
        initComponents();
         try {
    ...
    private void jbtnCheck_InActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCheck_InActionPerformed
        ...
        try {
            ...
            if (result.next()) {
                ...
                //refer to it self
                Delivery_Man_Job DMJ = new Delivery_Man_Job();
                DMJ.show();
                dispose();
            } else {
 ...
 //initliazation
        ...
        try {
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + address + "','" + ssn + "','" + password + "','"+"Delivery Man"+"');";
...
//insert
        ...
        try{    
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + ssn + "','" + "Delivery Man" + "','"+" "+"','" +""+"','" +""+ "');";
...
//insert
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(My_Delivery_Man.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new My_Delivery_Man().setVisible(true);
            }
        });
    }
