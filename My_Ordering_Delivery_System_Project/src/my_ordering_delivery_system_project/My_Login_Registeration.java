 ...
 * @author hp
 */
public class My_Login_Registeration extends javax.swing.JFrame {
        // no change
 //1
    ...
    /**
     * Creates new form My_Login_Registeration
     */
    public My_Login_Registeration() {
        initComponents();
//2
        try {
...
//insert
 ...
 //initliazation
        ...
        try {
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + address + "','" + ssn + "','" + password + "','"+"Customer"+"');";
...
//insert
        ...
        try{    
            ...
            con2 = DriverManager.getConnection(url);
            stmt2 = con2.createStatement();
            String query2 = "INSERT INTO ADMINSTRATOUR VALUES"                                                      //salary    //startdate  //enddate //id (remove)
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + ssn + "','" + "Customer" + "','"+" "+"','" +""+"','" +""+"');";
...
//insert
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(My_Login_Registeration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new My_Login_Registeration().setVisible(true);
            }
        });
    }
