 ...
 * @author hp
 */
public class My_Cheif extends javax.swing.JFrame {
 ...
 //initliazation
        ...
        try {
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + address + "','" + ssn + "','" + password + "','"+"Chief"+"');";
...
//insert
        ...
        try{    
            ...
            + "('" + fname + "','" + lname + "','" + email + "','" + phone + "','" + ssn + "','" + "Cheif" + "','"+" "+"','" +""+"','" +""+ "');";
...
//insert
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(My_Cheif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
